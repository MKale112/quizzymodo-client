...
const Footer = () => {
  return (
    <div>
      <footer className="bg-near-black white-80 pv4 pv4-l ph4">
        <div className="pv3 ph2 tc">
          <a
            className="link white hover-silver dib mh4 mh3-ns tc"
          ...
          <a
            className="link white hover-silver near-black dib mh4 mh3-ns tc"
        ...
        <p className="f6 tc">
          <span className="dib mr4 mr5-ns">©2020 Kale&Jere, Inc.</span>
